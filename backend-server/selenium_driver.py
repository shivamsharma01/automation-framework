...
class DriverManager:
    ...
    def __init__(self):
        '''
        Create a selenium web driver using chrome in headless mode
        login to mistral using provided username and password added to the environment
        '''
    ...
    def get_question_response(self, question):
        '''
        Input
        question: question to ask to mistral
        return: response generated by the mistral llm
        '''
        try:
